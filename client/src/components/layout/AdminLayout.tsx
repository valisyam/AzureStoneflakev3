...
export function AdminLayout({ children }: AdminLayoutProps) {
  ...
  const navigation = [
    ...
    { name: "Customer Companies", href: "/admin/customer-companies", icon: Building2 },
    { name: "Supplier Companies", href: "/admin/supplier-companies", icon: Building2 },
    { name: "Supplier Management", href: "/admin/supplier-management", icon: UserCheck },
    { name: "Messages", href: "/admin/messages", icon: MessageSquare },
    { name: "Create Quote", href: "/admin/create-quote", icon: FileText },
    { name: "Purchase Orders", href: "/admin/purchase-orders", icon: Package },
    { name: "Search Customers", href: "/admin/search", icon: Search },
  ...
  return (
    <div className="h-screen bg-gray-50 flex overflow-hidden">
      ...
      <div className={cn(
        "fixed inset-y-0 left-0 z-50 w-64 bg-gradient-to-b from-teal-800 via-slate-800 to-teal-900 transform transition-transform duration-300 ease-in-out lg:translate-x-0 lg:static lg:inset-0 flex flex-col h-screen",
        ...
        <div className="flex-shrink-0 p-4 border-t border-white/20">
          <div className="text-white text-sm mb-3">
            ...
            <div className="text-teal-200">{user?.name || 'Administrator'}</div>
          </div>
          <Button
            onClick={logout}
            variant="outline"
      ...
      <div className="flex-1 lg:ml-0 h-screen flex flex-col">
        {/* Top Header - Fixed */}
        <header className="bg-gradient-to-r from-teal-600 via-slate-600 to-teal-700 border-b border-teal-300/20 z-30 shadow-lg flex-shrink-0">
            ...
            <div className="flex items-center justify-between">
              ...
              <div className="flex-1 lg:flex lg:items-center lg:justify-center">
                <h2 className="text-lg font-semibold text-white lg:text-xl">
                  {navigation.find(item => item.href === location)?.name || 'Admin Portal'}
                </h2>
              </div>
